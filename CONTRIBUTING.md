...
If the on-page form is not yet wired, email the same details to the address in `config.js`.
...
Crowd-sourced lines are credited as **LinkedIn user 1**, **2**, and so on. Names are withheld on purpose. If one of those lines is yours and you want it under your name, say so in the sign form or by email. See [SOURCES.md](SOURCES.md).
